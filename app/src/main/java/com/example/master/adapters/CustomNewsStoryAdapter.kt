...
class CustomNewsStoryAdapter(private val context: Context, private val dataList: List<Story>) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
    ...
    val binding: ViewDataBinding = DataBindingUtil.inflate(inflater, R.layout.item_headline, parent, false)
      ...
      when (position) {
        0 -> {
            ...
            binding?.run {
              ...
              this.itemNewsHeadlineParent.visibility = View.GONE
            ...
            binding?.run {
              when (story.type.description) {
                ...
                ITEM_STORY_NEWS -> {
                  this.itemHeroStoryParent.visibility = View.GONE
                  this.itemVideoHeadlineParent.visibility = View.GONE
                  this.itemNewsHeadlineParent.visibility = View.VISIBLE

                  this.itemStoryTitle.text = story.headline.mobile
                }
              }
              executePendingBindings()
            }
